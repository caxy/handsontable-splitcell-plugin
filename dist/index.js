...
var _get2 = __webpack_require__(57);
...
var SplitCellPlugin = function (_Handsontable$plugins) {
  (0, _inherits3.default)(SplitCellPlugin, _Handsontable$plugins);

  function SplitCellPlugin() {
    (0, _classCallCheck3.default)(this, SplitCellPlugin);
    return (0, _possibleConstructorReturn3.default)(this, (SplitCellPlugin.__proto__ || (0, _getPrototypeOf2.default)(SplitCellPlugin)).apply(this, arguments));
  }

  (0, _createClass3.default)(SplitCellPlugin, [{
    key: 'isEnabled',
    ...
    value: function enablePlugin() {
      ...
      (0, _get3.default)(SplitCellPlugin.prototype.__proto__ || (0, _getPrototypeOf2.default)(SplitCellPlugin.prototype), 'enablePlugin', this).call(this);
    }
    ...
    key: 'addSplitActionsToContextMenu',
    value: function addSplitActionsToContextMenu(defaultOptions) {
      var _this2 = this;
      ...
      defaultOptions.items.push({
        ...
        callback: function callback() {
          return _this2.splitCellHorizontally();
        },
        disabled: function disabled() {
          return _this2.isContextMenuDisabled();
        }
      });
      ...
      defaultOptions.items.push({
        ...
        callback: function callback() {
          return _this2.splitCellVertically();
        },
        disabled: function disabled() {
          return _this2.isContextMenuDisabled();
        }
    ...
    key: 'isContextMenuDisabled',
    value: function isContextMenuDisabled() {
      var selected = this.hot.getSelected();

      var _selected = (0, _slicedToArray3.default)(selected, 4),
          startRow = _selected[0],
          startCol = _selected[1],
          endRow = _selected[2],
          endCol = _selected[3];

      var _ref = [Math.min(startRow, endRow), Math.min(startCol, endCol)],
          topRow = _ref[0],
          leftCol = _ref[1];
      ...
      var mergedCell = this.hot.mergeCells.mergedCellInfoCollection.getInfo(topRow, leftCol);
    ...
    key: 'splitCellHorizontally',
    value: function splitCellHorizontally() {
      this.splitCell('right');
    }
  }, {
    key: 'splitCellVertically',
    value: function splitCellVertically() {
      this.splitCell('down');
    }
    ...
    key: 'splitCell',
    value: function splitCell(direction) {
      var selected = this.hot.getSelected();

      var _selected2 = (0, _slicedToArray3.default)(selected, 2),
          startRow = _selected2[0],
          startCol = _selected2[1];

      var mergedCell = this.hot.mergeCells.mergedCellInfoCollection.getInfo(startRow, startCol);
    ...
    key: 'splitMergedCell',
    value: function splitMergedCell(mergedCell, direction) {
      var newCell = {};
      if (direction === 'right') {
        mergedCell.colspan--;
        newCell = _lodash2.default.clone(mergedCell);
    ...
    key: 'splitUnmergedCell',
    value: function splitUnmergedCell(startRow, startCol, mergedCell, direction) {
      var data = this.applySplitToData(direction, startCol, startRow, mergedCell);
    ...
    key: 'applySplitToData',
    value: function applySplitToData(direction, startCol, startRow, mergedCell) {
      var newCellIndex = direction === 'right' ? startCol + 1 : startRow + 1;
      var newCell = {
        row: startRow,
        col: startCol,
      ...
      if (direction === 'right') {
        data = _lodash2.default.map(data, function (row) {
          row.splice(startCol + 1, 0, '');
          return row;
        });
      } else {
        data.splice(startRow + 1, 0, _lodash2.default.map(this.hot.getDataAtRow(startRow), function () {
          return '';
        }));
      }
    ...
    key: 'shiftCellsAfterSplit',
    value: function shiftCellsAfterSplit(direction, data, startRow, startCol) {
      var loopCount = direction === 'right' ? data.length : this.hot.getDataAtRow(startRow).length;
      var currentCellIndex = direction === 'right' ? startRow : startCol;

      for (var i = 0; i < loopCount; i++) {
        var x = direction === 'right' ? i : startRow;
        var y = direction === 'right' ? startCol : i;
        var mergeParent = this.hot.mergeCells.mergedCellInfoCollection.getInfo(x, y);
  ...
  return SplitCellPlugin;
}(Handsontable.plugins.BasePlugin); /*global Handsontable*/


exports.default = SplitCellPlugin;
...
var _splitCellPlugin = __webpack_require__(46);

var _splitCellPlugin2 = _interopRequireDefault(_splitCellPlugin);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

// You need to register your plugin in order to use it within Handsontable.
Handsontable.plugins.registerPlugin('splitCellPlugin', _splitCellPlugin2.default); /*global Handsontable*/
exports.default = _splitCellPlugin2.default;
